...
export async function generateMetadata(
  ...
  return buildMetadata({
    ...
    description: 'Tattoo Freising: KishaTattoo München — 25 Minuten von Freising. Japanisches Irezumi, Fineline, Grafik Tattoo. Preisgekrönte Tattoo-Künstlerin. Termin buchen.',
