...
export async function generateMetadata(
  ...
  return buildMetadata({
    ...
    description: 'Tattoo in Ottobrunn? KishaTattoo München ist ca. 20 Minuten entfernt. Japanisches Irezumi, Fineline & Grafik Tattoo. Individuelles Custom-Design. Jetzt Termin buchen.',
